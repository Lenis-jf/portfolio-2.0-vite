      ...
      <section id="about-page" className="section light-section" ref={aboutPageRef}>
          ...
          <div className="hero-inner">
            ...
            <div className="hero-text">
              ...
              <div className="buttons-container">
                <a className="button" href="/assets/docs/Lebenslauf-2026-komprimiert.pdf" download>
                  Download CV
                </a>
        ...
        <div className="contact-cta">
          ...
          <div className="buttons-container">
            ...
            <a className="button" href={`${import.meta.env.BASE_URL}assets/docs/Lebenslauf-2026-komprimiert.pdf`} download>Download resume</a>
          </div>
        </div>
