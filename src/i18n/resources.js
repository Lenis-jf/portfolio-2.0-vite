export const resources = {
  en: {
    translation: {
      ...
      about: {
        documentTitle: "About Juanfelenis — Software Engineer & Web Developer",
        heroTitle: "Hi — I am Juan Fernando Lenis Serna",
        tagline1: "Colombian Computer Science student at Frankfurt University of Applied Sciences. I build intuitive, resilient web apps with an emphasis on UX, accessibility, and attention to detail.",
        tagline2: "Beyond the web, I enjoy exploring new technologies and ideas, from small automations to creative tools. I love learning, experimenting, and finding elegant ways to make things work better.",
        downloadCv: "Download CV",
        contact: "Contact",
        portraitAlt: "Portrait of Juanfelenis",
        snapshot: {
          locationLabel: "Location",
          locationValue: "Frankfurt am Main, Germany",
          educationLabel: "Education",
          educationValue: "B.Sc. Computer Science — Frankfurt UAS",
          languagesLabel: "Languages",
          languagesValue: "Spanish · English · German (C1)",
          focusLabel: "Focus",
          focusValue: "Frontend · UX · accessibility · performance"
        },
        aboutMeTitle: "About me",
        aboutMeP1: "I am a developer from Colombia, currently studying Computer Science in Frankfurt. I love turning ideas into polished, reliable products, blending a designer's eye for detail with the discipline of engineering.",
        aboutMeP2: "I care deeply about usability and edge cases; I like when software behaves gracefully even under the unexpected. Collaboration keeps me inspired, I enjoy learning from others and building things that feel right to use.",
        processTitle: "How I work",
        process: {
          discover: "Discover — understand users and their needs.",
          design: "Design — structure ideas through clear interfaces.",
          develop: "Develop — code clean, accessible, and testable components.",
          refine: "Refine — improve with feedback and performance insights."
        },
        highlightsTitle: "Selected highlights",
        highlights: {
          leontiTitle: "Leonti Aesthetic — Studio Website",
          leontiText: "Fast, maintainable React landing page highlighting services, pricing and partner products. Implemented image optimization, Google Maps, Search Console tracking and automated asset tasks; deployed via SFTP.",
          dronesTitle: "Drones Simulation — Java GUI",
          dronesText: "Desktop Java application demonstrating API integration and real-time data visualization. Features searchable views, computed metrics and robust pagination, developed as an OOP university class team project.",
          roommanTitle: "Roomman — Distributed Room Manager",
          roommanText: "Modular client-server system implementing sockets and RPC (SunRPC in later stages) for synchronized room management. Focus on concurrency, payload encoding, fault handling and scalable communication; top-scored across iterative submissions.",
          readMore: "Read more"
        },
        ctaTitle: "Want to work together?",
        ctaText: "If you would like to collaborate or hire me, please get in touch.",
      ...
      projectPage: {
        ...
        titleSuffix: "Juanfelenis Portfolio"
      },
      projectCard: {
        githubAlt: "GitHub logo",
        showRepository: "Show Repository",
        seeMore: "See more about it",
  ...
  es: {
    translation: {
      header: {
        menuAria: "Alternar menu de navegacion",
        menuInputAria: "Abrir menu",
        mainNavigationAria: "Navegacion principal",
      ...
      about: {
        documentTitle: "Sobre Juanfelenis — Ingeniero de Software y Desarrollador Web",
        heroTitle: "Hola — Soy Juan Fernando Lenis Serna",
        tagline1: "Estudiante colombiano de Ciencias de la Computacion en Frankfurt University of Applied Sciences. Construyo aplicaciones web intuitivas y robustas con enfoque en UX, accesibilidad y detalle.",
        tagline2: "Mas alla de la web, disfruto explorar nuevas tecnologias e ideas, desde pequenas automatizaciones hasta herramientas creativas.",
        downloadCv: "Descargar CV",
        contact: "Contacto",
        portraitAlt: "Retrato de Juanfelenis",
        snapshot: {
          locationLabel: "Ubicacion",
          locationValue: "Frankfurt am Main, Alemania",
          educationLabel: "Educacion",
          educationValue: "B.Sc. Ciencias de la Computacion — Frankfurt UAS",
          languagesLabel: "Idiomas",
          languagesValue: "Espanol · Ingles · Aleman (C1)",
          focusLabel: "Enfoque",
          focusValue: "Frontend · UX · accesibilidad · rendimiento"
        },
        aboutMeTitle: "Sobre mi",
        aboutMeP1: "Soy un desarrollador de Colombia, actualmente estudiando Ciencias de la Computacion en Frankfurt. Me encanta convertir ideas en productos pulidos y confiables.",
        aboutMeP2: "Me importa mucho la usabilidad y los casos limite. La colaboracion me mantiene motivado.",
        processTitle: "Como trabajo",
        process: {
          discover: "Descubrir — entender a los usuarios y sus necesidades.",
          design: "Disenar — estructurar ideas con interfaces claras.",
          develop: "Desarrollar — escribir componentes limpios, accesibles y testeables.",
          refine: "Refinar — mejorar con feedback e indicadores de rendimiento."
        },
        highlightsTitle: "Destacados",
        highlights: {
          leontiTitle: "Leonti Aesthetic — Sitio de Estudio",
          leontiText: "Landing page en React rapida y mantenible con servicios, precios y productos aliados.",
          dronesTitle: "Drones Simulation — Java GUI",
          dronesText: "Aplicacion de escritorio en Java con integracion de APIs y visualizacion de datos en tiempo real.",
          roommanTitle: "Roomman — Gestor Distribuido",
          roommanText: "Sistema cliente-servidor modular con sockets y RPC para gestion sincronizada de aulas.",
          readMore: "Leer mas"
        },
        ctaTitle: "Quieres trabajar conmigo?",
        ctaText: "Si quieres colaborar o contratarme, escribeme.",
      ...
      projectPage: {
        ...
        titleSuffix: "Portafolio de Juanfelenis"
      },
      projectCard: {
        githubAlt: "Logo de GitHub",
        showRepository: "Ver repositorio",
        seeMore: "Ver mas sobre esto",
        builtWith: "Hecho con:"
      },
      projects: {
        actions: {
  ...
  de: {
    translation: {
      header: {
        menuAria: "Navigationsmenu umschalten",
        menuInputAria: "Menü öffnen",
      ...
      about: {
        documentTitle: "Über Juanfelenis — Softwareingenieur und Webentwickler",
        heroTitle: "Hi — Ich bin Juan Fernando Lenis Serna",
        tagline1: "Kolumbianischer Informatikstudent an der Frankfurt University of Applied Sciences. Ich entwickle intuitive und robuste Web-Apps mit Fokus auf UX, Barrierefreiheit und Details.",
        tagline2: "Abseits vom Web erkunde ich gerne neue Technologien und Ideen, von kleinen Automatisierungen bis zu kreativen Tools.",
        downloadCv: "CV herunterladen",
        contact: "Kontakt",
        portraitAlt: "Porträt von Juanfelenis",
        snapshot: {
          locationLabel: "Standort",
          locationValue: "Frankfurt am Main, Deutschland",
          educationLabel: "Ausbildung",
          educationValue: "B.Sc. Informatik — Frankfurt UAS",
          languagesLabel: "Sprachen",
          languagesValue: "Spanisch · Englisch · Deutsch (C1)",
          focusLabel: "Fokus",
          focusValue: "Frontend · UX · Barrierefreiheit · Performance"
        },
        aboutMeTitle: "Über mich",
        aboutMeP1: "Ich bin Entwickler aus Kolumbien und studiere derzeit Informatik in Frankfurt. Ich liebe es, Ideen in zuverlässige und hochwertige Produkte umzusetzen.",
        aboutMeP2: "Usability und Sonderfälle sind mir wichtig. Zusammenarbeit motiviert mich und ich lerne gerne mit anderen.",
        processTitle: "So arbeite ich",
        process: {
          discover: "Entdecken — Nutzer und ihre Bedürfnisse verstehen.",
          design: "Design — Ideen durch klare Interfaces strukturieren.",
          develop: "Entwickeln — saubere, barrierefreie und testbare Komponenten bauen.",
          refine: "Verbessern — mit Feedback und Performance-Einblicken optimieren."
        },
        highlightsTitle: "Ausgewählte Highlights",
        highlights: {
          leontiTitle: "Leonti Aesthetic — Studio-Website",
          leontiText: "Schnelle und wartbare React-Landingpage mit Services, Preisen und Partnerprodukten.",
          dronesTitle: "Drones Simulation — Java GUI",
          dronesText: "Desktop-Java-Anwendung mit API-Integration und Echtzeit-Datenvisualisierung.",
          roommanTitle: "Roomman — Verteilter Raum-Manager",
          roommanText: "Modulares Client-Server-System mit Sockets und RPC für synchronisierte Raumverwaltung.",
          readMore: "Mehr lesen"
        },
        ctaTitle: "Lust auf Zusammenarbeit?",
        ctaText: "Wenn du mit mir zusammenarbeiten oder mich einstellen möchtest, melde dich gern.",
